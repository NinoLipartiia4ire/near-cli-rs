...
pub struct CliAddAction {
    #[clap(skip)]
    context: Option<crate::common::Context>,
    #[clap(subcommand)]
...
impl ToCli for AddAction {
    type CliVariant = CliAddAction;
}
...
impl AddAction {
    pub fn from(
        item: Option<CliAddAction>,
        context: crate::common::Context,
    ) -> color_eyre::eyre::Result<Self> {
        let context = crate::common::Context::default();
        let action = match item.and_then(|f| f.action) {
            Some(cli_action) => Action::from(cli_action, context.clone())?,
            None => Action::choose_action(context.clone())?,
        };
...
impl Action {
    fn from(item: CliAction, context: crate::common::Context) -> color_eyre::eyre::Result<Self> {
        match item {
            CliAction::AccessKey(cli_operation_mode) => Ok(Action::AccessKey(
                self::access_key::operation_mode::OperationMode::from(
...
impl Action {
    fn choose_action(context: crate::common::Context) -> color_eyre::eyre::Result<Self> {
        println!();
        ...
        Ok(Self::from(cli_action, context)?)
    }
